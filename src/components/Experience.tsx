    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <motion.div
          ...
          className="h-full"
        >
          <Card className="project-card relative overflow-hidden h-full">
            {/* existing first card content */}
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    >
                      <div className="h-8 w-8 mx-auto mb-2 text-accent font-bold text-xl">2cr+</div>
                      <p className="text-sm text-muted-foreground">Customer Data</p>
                    </motion.div>
                    <motion.div
                      whileHover={{ scale: 1.02 }}
                      className="text-center p-4 rounded-lg bg-secondary/10 border border-secondary/20"
                    >
                      <div className="h-8 w-20 mx-auto mb-2 text-foreground font-bold text-lg">LangGraph</div>
                      <p className="text-sm text-muted-foreground">Multiagent</p>
                    </motion.div>
                  </div>
...
Built and deployed an Agentic AI assistant using Python, LangGraph and LangChain to enable intelligent workflows
over 1 crore customer records and more than 50 lakh dealer profiles                        </span>
                      </motion.li>
                      <motion.li
                        initial={{ opacity: 0, x: -20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                      ...
                      >
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" />
                        <span className="text-muted-foreground">
                          Engineered RAG-based NLP pipelines to scrape and semantically analyze 6M+ customer reviews, generating
dealer sentiment scores and quality insights, reducing manual analysis effort by 60–70%
                        </span>
                      </motion.li>
                      {/* <motion.li
                        initial={{ opacity: 0, x: -20 }}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Python", "Langgraph", "LangChain", "LLM"].map((tech) => (
